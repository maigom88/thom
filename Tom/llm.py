...
class LLM():
    ...
    def process_functions(self, text):
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                    ...
                    {"role": "system", "content": "Eres un asistente muy sabio"},
                ...
                {
                    "name": "tom",
                    "description": "Obtener respuesta al estilo del maestro Yoda de Star Wars",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "ubicacion": {
    ...
    def process_response(self, text, message, function_name, function_response):
                ...
                if function_name == 'tom':
                     # Aquí puedes personalizar el mensaje del sistema para la función 'tom'
                     system_content = "Eres un asistente muy sabio con la sabiduría de Yoda he inviertes las palabras"
                else:
                     system_content = "Eres un asistente muy sabio con un complejo de superioridad"
